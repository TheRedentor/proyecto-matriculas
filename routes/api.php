...
Route::group(['middleware' => ['auth:api'/*, 'throttle:time'*/]], function(){
    ...
    Route::delete('mode/delete', [ModeController::class, 'deleteMode'])->name('deleteMode');
    ...
    Route::delete('plate/list/remove', [LicensePlatesController::class, 'removePlateFromList'])->name('removePlateFromList');
    Route::delete('list/delete', [LicensePlatesController::class, 'deleteList'])->name('deleteList');
    ...
    Route::delete('source/1/delete', [SourceController::class, 'deleteSourceMode1'])->name('deleteSourceMode1');
    Route::delete('source/2/delete', [SourceController::class, 'deleteSourceMode2'])->name('deleteSourceMode2');
    Route::delete('source/3/delete', [SourceController::class, 'deleteSourceMode3'])->name('deleteSourceMode3');
    Route::delete('source/4/delete', [SourceController::class, 'deleteSourceMode4'])->name('deleteSourceMode4');
});
